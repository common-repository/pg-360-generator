...
class Pg360_Public {
	...
	public function pg360_enqueue_styles() {
		...
		wp_enqueue_style( $this->pg360_generator, plugin_dir_url( __FILE__ ) . 'css/pg360-public.css', array('dashicons'), $this->pg360_generator_version, 'all' );
	...
	public function pg360_enqueue_scripts() {
		...
		wp_enqueue_script('jquery191',plugins_url( '/pg-360-generator/admin/js/jquery191.js'), array(),'',false);
