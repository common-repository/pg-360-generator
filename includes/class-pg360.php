...
class Pg360 {
	...
	private function pg360_define_admin_hooks() {
		...
		//gallery edit/delete/restore default settings/edit-delete annotation
		...
		$this->pg360_loader->add_action( 'wp_ajax_pg360_add_annotation',$pg360ProjectED,'pg360_add_annotation');

		$this->pg360_loader->add_action( 'wp_ajax_pg360_delete_annotation',$pg360ProjectED,'pg360_delete_annotation');
		
		$this->pg360_loader->add_action( 'wp_ajax_pg360_delete_all_annotation',$pg360ProjectED,'pg360_delete_all_annotation');


		$this->pg360_loader->add_action( 'wp_ajax_pg360_restore_default_settings',$pg360ProjectED, 'pg360_restore_default_settings');
